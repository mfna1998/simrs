...
<head>
	...
	<title>List Data Pendaftaran</title>
			...
			<div class="section__content section__content--p30">
				<div class="container-fluid">
					<div class="header-wrap">
						<form action="<?php echo site_url('pendaftaran'); ?>" class="form-inline" method="get">
							...
							<table class="table table-data2">
								<thead>
									<tr>
										...
										<th>JENIS PASIEN</th>
                                        <th>NAMA_KELUARGA</th>
                                        <th>PEKERJAAN KELUARGA</th>
										<th>Action</th>
									</tr>
								</thead>
								<?php
                                // if (is_array($pendaftaran_data) || is_object($pendaftaran_data))
                                // {
								...
								<tr center>
									...
									<td><?php echo $pendaftaran->DESKRIPSI ?></td>
									<td><?php echo $pendaftaran->TUJUANPERIKSA ?></td>
									<td><?php echo $pendaftaran->JENIS_PASIEN ?></td>
                                    <td><?php echo $pendaftaran->NAMA_KELUARGA ?></td>
                                    <td><?php echo $pendaftaran->JENIS ?></td>
								
									<td style="text-align:center" width="200px">
										<?php 
                                        echo anchor(site_url('pendaftaran/read/'.$pendaftaran->NORM), ' ', 'i class="btn btn-outline-primary zmdi zmdi-eye" title="Detail"');
                                        ?>
										<?php	
                                        echo anchor(site_url('pendaftaran/update/'.$pendaftaran->NORM),' ', 'i class="btn btn-outline-warning zmdi zmdi-edit" title="Edit"');
                                        ?>
                                        <?php	 
                                        echo anchor(site_url('pendaftaran/delete/'.$pendaftaran->NORM),' ', 'i class="btn btn-outline-danger zmdi zmdi-delete" title="Delete"','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                                        ?>
									</td>
								</tr>
								<tr class="spacer"></tr>
