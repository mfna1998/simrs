...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Kontak_keluarga_pasien List</h2>
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('kontak_keluarga_pasien/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('kontak_keluarga_pasien'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('kontak_keluarga_pasien/read/'.$kontak_keluarga_pasien->SHDK),'Read'); 
				echo ' | '; 
